package org.gurski.javabrains.rest.client;
...
public class InvocationDemo {
	...
	public static void main(String[] args) {
		...
		// API to get all messages by year: /webappi/messages?year={year}
	...
	public Invocation prepareRequestForMessagesByYear(int year) {
		...
		return client
			.target("http://localhost:8080/advanced-jaxrs-06/webapi/")
			.path("messages")
